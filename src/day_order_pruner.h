...
//   - `next_fire`: pure function returning the next fire `time_point` given
//                  `now`. Use `nextDailyCutoff` for the standard end-of-day
//                  schedule, or any other function for testing / alternative
//                  schedules.
//
